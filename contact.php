    ...
    <div class="wrapper clearfix">
      ...
      <section class="col-2 first shadow">
        ...
        <?php } else if ($_GET['s'] == 'error') { ?>
          <p>Error. Your message was not sent! Make sure you type in the proper verification numbers. <a href="contact.php">Click here to try again.</a>If issues persist please send an email to the site admin (your@email.com)</p>
